...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fEntry2 = FAUSTFLOAT(0.10000000000000001);
		fEntry3 = FAUSTFLOAT(0.0);
		fEntry4 = FAUSTFLOAT(1.0);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("trigger", &fEntry0, 0.0, -9999.0, 9999.0, 0.0001);
		ui_interface->declare(&fEntry2, "2", "");
		ui_interface->addNumEntry("attack", &fEntry2, 0.10000000000000001, 0.0, 9999.0, 0.0001);
		ui_interface->declare(&fEntry3, "3", "");
		ui_interface->addNumEntry("decay", &fEntry3, 0.0, 0.0, 9999.0, 0.0001);
		ui_interface->declare(&fEntry4, "4", "");
		ui_interface->addNumEntry("sustain", &fEntry4, 1.0, 0.0, 1.0, 0.0001);
		ui_interface->declare(&fEntry1, "5", "");
		ui_interface->addNumEntry("release", &fEntry1, 0.10000000000000001, 0.0, 9999.0, 0.0001);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		int iSlow5 = (1 - iSlow1);
		int iSlow6 = mydsp_faustpower2_i(iSlow1);
		int iSlow7 = ((fSlow0 == 0.0) > 0);
		double fSlow8 = double(fEntry2);
		double fSlow9 = double(fEntry3);
		double fSlow10 = (fConst0 * (fSlow8 + fSlow9));
		double fSlow11 = (fConst0 * fSlow8);
		double fSlow12 = (double(fEntry4) * fSlow0);
		double fSlow13 = ((fSlow12 + -1.0) / (0.0 - (fConst0 * (0.0 - fSlow9))));
		double fSlow14 = (fConst1 / fSlow8);
		double fSlow15 = (fConst1 / fSlow3);
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec0[0] = (iSlow2?0.0:min(fSlow4, (fRec0[1] + 1.0)));
			fRec2[0] = (iSlow7?0.0:min(fSlow10, (fRec2[1] + 1.0)));
			int iTemp0 = (fRec2[0] < fSlow11);
			fRec1[0] = ((double(iSlow5) * fRec1[1]) + (double(iSlow6) * (iTemp0?((fRec2[0] < 0.0)?0.0:(iTemp0?(fSlow14 * fRec2[0]):1.0)):((fRec2[0] < fSlow10)?((fSlow13 * (fRec2[0] - fSlow11)) + 1.0):fSlow12))));
	...
	FAUST_ADDNUMENTRY("trigger", fEntry0, 0.0, -9999.0, 9999.0, 0.0001);
	FAUST_ADDNUMENTRY("attack", fEntry2, 0.10000000000000001, 0.0, 9999.0, 0.0001);
	FAUST_ADDNUMENTRY("decay", fEntry3, 0.0, 0.0, 9999.0, 0.0001);
	FAUST_ADDNUMENTRY("sustain", fEntry4, 1.0, 0.0, 1.0, 0.0001);
	FAUST_ADDNUMENTRY("release", fEntry1, 0.10000000000000001, 0.0, 9999.0, 0.0001);
#endif
